<div class="row">
	<div class="col-sm-6 col-sm-offset-3">
		...
		<form id="application-form" class="form-horizontal big-input vertical" method="POST" role="form">
			...
			<div class="form-group">
				<div class="col-xs-12">
					<label class="col-xs-12 control-label no-padding-left no-padding-right align-left bigger important">Are you a member of any vacation rental websites?</label>
