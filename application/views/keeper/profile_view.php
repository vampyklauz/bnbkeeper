								...
								<div class="col-xs-12 col-sm-9">
									...
									<div class="profile-user-info">
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<span id="language"><?php echo isset($users['personal']->language) ? $users['personal']->language: ''; ?></span>
											</div>
										</div>
									...
									<div class="profile-user-info">
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<span id="about"><?php echo ( isset($users['personal']->about) && $users['personal']->about != '' ) ? $users['personal']->about: 'Say something'; ?></span>
											</div>
										</div>
									</div>
								</div><!-- /.col -->
